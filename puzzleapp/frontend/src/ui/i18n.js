const STRINGS = {
  ...
  en: {
    ...
    analyticsDescConnDashboard: "Left panel: off-grid assembly imprint (color = time). Right panel: the First Connection diagram shows when each piece was first joined with a neighbor (off-grid or within the puzzle area); below it, the Group growth diagram shows how groups merged over time. Pieces and time points can be selected by clicking.",
