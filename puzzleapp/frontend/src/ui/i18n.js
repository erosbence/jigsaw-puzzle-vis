const STRINGS = {
  hu: {
    ...
    heatmapExport: "Hőtérkép mentése (SVG)",
    heatmapLegendMin: "Legkorábbi",
    heatmapLegendMax: "Legkésőbbi",
    heatmapLegendEmpty: "Nincs helyere illesztve egy elem sem",
    heatmapExportUnavailable: "A hőtérkép mentése csak 2x2 vagy 6x6 puzzle esetén elérhető.",
  ...
  en: {
    ...
    heatmapExport: "Save heatmap (SVG)",
    heatmapLegendMin: "Earliest",
    heatmapLegendMax: "Latest",
    heatmapLegendEmpty: "No pieces have been placed yet",
    heatmapExportUnavailable: "Heatmap export is available only for 2x2 or 6x6 puzzles.",
